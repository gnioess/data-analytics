(function () {
  ...
  function renderCostosCategoria(categoria, chartId, capId, maquina, maquinaTxt) {
    ...
    renderGroupedBarChart(el(chartId), {
      categories: MESES_ABBR,
      series: [
        { name: 'Real', color: 'var(--series-1)', values: data.months.map(function (m) { return m.real; }) },
        { name: 'Presupuesto', color: 'var(--text-muted)', values: data.months.map(function (m) { return m.ppto; }) }
      ],
